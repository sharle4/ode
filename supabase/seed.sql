...
('d2222222-2222-2222-2222-222222222222', 'Aube', 'arthur-rimbaud-aube', 'a2222222-2222-2222-2222-222222222222', 'c2222222-2222-2222-2222-222222222222', null, '{"stanzas": [["J''ai embrassé l''aube d''été.", "Rien ne bougeait encore au front des palais. L''eau était morte. Les camps d''ombres ne quittaient pas la route du bois. J''ai marché, réveillant les haleines vives et tièdes, et les pierreries regardèrent, et les ailes se levèrent sans bruit."]]}', 'J''ai embrassé l''aube d''été...');

-- Add some tags
insert into public.tags (id, name, category) values 
('e1111111-1111-1111-1111-111111111111', 'Mélancolie', 'theme'),
('e2222222-2222-2222-2222-222222222222', 'Sonnet', 'form');
