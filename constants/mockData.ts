...
export const poems: Poem[] = [
  {
    ...
    authors: [{ id: "pablo-neruda-id", name: "Pablo Neruda", slug: "pablo-neruda" }],
  ...
  },
  {
    ...
    authors: [{ id: "charles-baudelaire-id", name: "Charles Baudelaire", slug: "charles-baudelaire" }],
  ...
  },
  {
    ...
    authors: [{ id: "matsuo-basho-id", name: "Matsuo Basho", slug: "matsuo-basho" }],
  ...
  },
  {
    ...
    authors: [{ id: "emily-dickinson-id", name: "Emily Dickinson", slug: "emily-dickinson" }],
  ...
  },
  {
    ...
    authors: [{ id: "jalal-al-din-rumi-id", name: "Jalal al-Din Rumi", slug: "jalal-al-din-rumi" }],
  ...
  },
  {
    id: "poem-006",
    title: "Lady Lazarus",
    authors: [{ id: "sylvia-plath-id", name: "Sylvia Plath", slug: "sylvia-plath" }],
    originalLanguage: "Anglais",
  ...
  },
  {
    ...
    authors: [{ id: "arthur-rimbaud-id", name: "Arthur Rimbaud", slug: "arthur-rimbaud" }],
    originalLanguage: "Français",
  ...
  },
  {
    ...
    authors: [{ id: "wb-yeats-id", name: "W.B. Yeats", slug: "wb-yeats" }],
    originalLanguage: "Anglais",
  ...
  },
  {
    ...
    authors: [{ id: "li-bai-id", name: "Li Bai", slug: "li-bai" }],
  ...
  },
  {
    id: "poem-010",
    title: "Fragment 31",
    authors: [{ id: "sappho-id", name: "Sappho", slug: "sappho" }],
  ...
  },
  {
    ...
    authors: [{ id: "federico-garcia-lorca-id", name: "Federico Garcia Lorca", slug: "federico-garcia-lorca" }],
    originalLanguage: "Espagnol",
  ...
  },
  {
    ...
    authors: [{ id: "walt-whitman-id", name: "Walt Whitman", slug: "walt-whitman" }],
    originalLanguage: "Anglais",
  ...
  },
  {
    ...
    authors: [{ id: "john-keats-id", name: "John Keats", slug: "john-keats" }],
    originalLanguage: "Anglais",
  ...
  },
  {
    ...
    authors: [{ id: "anna-akhmatova-id", name: "Anna Akhmatova", slug: "anna-akhmatova" }],
  ...
  },
  {
    ...
    authors: [{ id: "fernando-pessoa-id", name: "Fernando Pessoa", slug: "fernando-pessoa" }],
...
export const communityActivities: CommunityActivity[] = [
  {
    ...
    poemAuthors: [{ id: "wb-yeats-id", name: "W.B. Yeats", slug: "wb-yeats" }],
    review: 4.5,
    reviewText:
  ...
  },
  {
    ...
    poemAuthors: [{ id: "matsuo-basho-id", name: "Matsuo Basho", slug: "matsuo-basho" }],
    timestamp: "il y a 3h",
    likes: 23,
    comments: 4,
  },
  {
    ...
    poemAuthors: [{ id: "sylvia-plath-id", name: "Sylvia Plath", slug: "sylvia-plath" }],
    review: 5,
    reviewText:
  ...
  },
  {
    ...
    poemAuthors: [{ id: "sappho-id", name: "Sappho", slug: "sappho" }],
    timestamp: "il y a 5h",
    likes: 15,
    comments: 2,
  },
  {
    ...
    poemAuthors: [{ id: "federico-garcia-lorca-id", name: "Federico Garcia Lorca", slug: "federico-garcia-lorca" }],
    review: 4,
    reviewText:
  ...
  },
  {
    ...
    poemAuthors: [{ id: "charles-baudelaire-id", name: "Charles Baudelaire", slug: "charles-baudelaire" }],
    review: 4.5,
    timestamp: "il y a 7h",
    likes: 34,
    comments: 8,
  },
  {
    ...
    poemAuthors: [{ id: "jalal-al-din-rumi-id", name: "Jalal al-Din Rumi", slug: "jalal-al-din-rumi" }],
    review: 5,
    reviewText:
  ...
  },
  {
    ...
    poemAuthors: [{ id: "fernando-pessoa-id", name: "Fernando Pessoa", slug: "fernando-pessoa" }],
    review: 4.5,
    reviewText:
