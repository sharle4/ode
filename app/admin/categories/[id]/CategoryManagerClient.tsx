...
export default function CategoryManagerClient({ 
    ...
    const [type, setType] = useState(initialCategory?.type || 'THEME')
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="mb-2 block text-sm font-medium text-zinc-400">Type de catégorie *</label>
                            <select
                                value={type}
                            ...
                            >
                                ...
                                <option value="MOVEMENT">Mouvement poétique</option>
                                <option value="ERA">Époque</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="mb-2 block text-sm font-medium text-zinc-400 flex items-center gap-2">
                                ...
                                <span title="Les catégories avec un grand numéro de priorité apparaissent en premier.">
                                    <Info className="text-zinc-500" />
                                </span>
                            </label>
                            <input
