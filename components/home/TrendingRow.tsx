        ...
        <div className="flex items-end justify-between mb-6 md:mb-8">
          ...
          <div className="hidden md:flex items-center gap-2">
            <motion.button
              ...
              className="flex items-center justify-center w-9 h-9 rounded-full border border-soft-border/60 text-warm-gray hover:text-charcoal hover:border-soft-border transition-colors"
