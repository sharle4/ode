  ...
  return (
    <footer className="border-t border-zinc-900 bg-zinc-950">
      <div className="mx-auto max-w-[1400px] px-4 md:px-8 py-16 md:py-24">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
          {footerColumns.map((column) => (
            <div key={column.title}>
              <h3 className="text-xs font-medium uppercase tracking-widest text-zinc-500 mb-5">
                {column.title}
              </h3>
        ...
        <div className="mt-16 md:mt-24 flex flex-col items-center gap-6 border-t border-zinc-900 pt-10">
          <div className="w-16 opacity-40">
            <OdeLogo width="100%" height="auto" />
          </div>
          <p className="text-xs text-zinc-500 text-center max-w-[40ch]">
